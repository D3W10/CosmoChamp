        ...
        <div class="w-full h-full flex flex-col justify-center items-center space-y-20">
            ...
            <div class="w-[115%] h-1/2 flex items-center space-x-0.5">
                <div class="w-full h-full flex justify-center items-start pt-10 overflow-hidden -skew-x-[35deg]">
                    <p class="mr-12 text-shade/20 text-4xl font-semibold skew-x-[35deg] whitespace-nowrap" in:fly={{ duration: 2000, x: -410, easing: quintOut, opacity: 1 }} out:fly={{ duration: 2000, x: 500, easing: quintIn, opacity: 1 }} on:introend={() => versus = false}>{$game?.host ? $settings?.playerName : $game?.opponent}</p>
                </div>
                ...
                <div class="w-full h-full flex justify-center items-end pb-10 overflow-hidden -skew-x-[35deg]">
                    <p class="ml-12 text-shade/20 text-4xl font-semibold skew-x-[35deg] whitespace-nowrap" in:fly={{ duration: 2000, x: 410, easing: quintOut, opacity: 1 }} out:fly={{ duration: 2000, x: -500, easing: quintIn, opacity: 1 }}>{!$game?.host ? $settings?.playerName : $game?.opponent}</p>
                </div>
            </div>
        </div>
    {/if}
