...
<dialog class="w-[28rem] max-h-112 transition-all ease-quint-out opacity-0 {show ? "open" : "closed"} {!$settings.reduceMotion ? "duration-[400ms] scale-50" : "duration-200 scale-75 reduced"} overflow-hidden" bind:this={dialog} on:close={() => show = false}>
